...
- [X] [UFB-0001. `/start` greeting](features/UFB-0001-start-greeting.md) - `#telegram` `#commands`
- [X] [UFB-0002. Multi-URL message scanning](features/UFB-0002-multi-url-scanning.md) - `#telegram` `#url`
- [X] [UFB-0003. Private-chat no-URL prompt](features/UFB-0003-private-no-url-prompt.md) - `#telegram` `#ux`
- [X] [UFB-0004. Group-chat quietness](features/UFB-0004-group-chat-quietness.md) - `#telegram` `#groups`
- [X] [UFB-0005. Reply-to-bot easter egg](features/UFB-0005-reply-to-bot-easter-egg.md) - `#telegram` `#groups` `#easter-egg`
- [X] [UFB-0006. URL validation errors](features/UFB-0006-url-validation-errors.md) - `#telegram` `#validation`
- [X] [UFB-0007. Redirect resolution](features/UFB-0007-redirect-resolution.md) - `#url` `#redirects`
- [X] [UFB-0008. Query-string stripping](features/UFB-0008-query-string-stripping.md) - `#url` `#privacy`
- [X] [UFB-0009. Download allow-list](features/UFB-0009-download-allow-list.md) - `#config` `#download` `#allowlist`
- [X] [UFB-0010. Mirror link for disallowed domains](features/UFB-0010-mirror-link-disallowed-domains.md) - `#rewrite` `#url`
...
- [X] [UFB-0018. Persistent cookie jar](features/UFB-0018-persistent-cookie-jar.md) - `#download` `#cookies` `#config`
- [X] [UFB-0019. REST URL-processing endpoint](features/UFB-0019-rest-url-processing-endpoint.md) - `#api`
- [X] [UFB-0020. In-process bot polling](features/UFB-0020-in-process-bot-polling.md) - `#runtime`
- [X] [UFB-0021. Environment-based configuration](features/UFB-0021-environment-based-configuration.md) - `#config`
- [X] [UFB-0022. Configurable mirror domains](features/UFB-0022-configurable-mirror-domains.md) - `#config` `#rewrite`
- [X] [UFB-0023. Rewrite domain allow-list](features/UFB-0023-rewrite-domain-allowlist.md) - `#config` `#rewrite` `#allowlist`
- [X] [UFB-0024. Configurable log level](features/UFB-0024-configurable-log-level.md) - `#config` `#ops`
- [X] [UFB-0025. Themed download file server](features/UFB-0025-themed-download-file-server.md) - `#ops` `#hosting`
- [X] [UFB-0026. Cached-file TTL cleanup](features/UFB-0026-cached-file-ttl-cleanup.md) - `#ops` `#cache`
- [X] [UFB-0027. Docker Compose stack with Traefik routing](features/UFB-0027-compose-stack-traefik-routing.md) - `#ops` `#deploy`
- [X] [UFB-0028. Multi-arch CI image publishing](features/UFB-0028-multi-arch-ci-image-publishing.md) - `#ops` `#ci`
- [X] [UFB-0029. Threads mirror-domain rewrites](features/UFB-0029-threads-mirror-rewrites.md) - `#rewrite`
- [X] [UFB-0030. Registry-only deployment](features/UFB-0030-registry-only-deployment.md) - `#ops` `#deploy`
- [X] [UFB-0031. Landing page](features/UFB-0031-landing-page-and-cache-index.md) - `#ops` `#hosting`
